...
import funkatronics.code.tactilewaves.dsp.toolbox.MFCC;

/**
 * Processor Class that extracts MFCCs from an audio buffer
 *
...
public class MFCCExtractor implements WaveProcessor {

    public boolean process(WaveFrame frame) {
        double[] MFCCs = MFCC.getMFCCs(frame.getSamples(), frame.getSampleRate());
        frame.addFeature("MFCCs", MFCCs);
        return true;
    }
